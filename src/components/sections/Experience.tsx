            ...
            >
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
                 ...
                 <div className="text-right flex flex-col md:items-end">
                    <span className="text-sm font-semibold px-3 py-1 rounded-full bg-white/5 border border-white/5 text-[var(--color-text-muted)] group-hover:text-violet-300 transition-colors">
                      {exp.period}
                    </span>
              ...
              {exp.tags && (
                <div className="flex flex-wrap gap-2">
                   {exp.tags.map(tag => (
                     <span key={tag} className="text-[10px] uppercase font-bold tracking-widest px-2.5 py-1 rounded-lg bg-black/40 border border-white/5 text-[var(--color-text-muted)] group-hover:border-violet-500/30 transition-colors">
                       {tag}
                     </span>
                   ))}
                </div>
